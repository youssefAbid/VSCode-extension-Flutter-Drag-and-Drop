<script>
    ...
    // the index of the basket from which it is leaving.
        ...
        console.log("The data basketIndex is : "+data.basketIndex);
        console.log("The data itemIndex is : "+data.itemIndex);
    ...
    const json = event.dataTransfer.getData("text/plain");
		...
		console.log("The drop json is : "+json);
        console.log("the drop data is : "+data);

		// Remove the item from one basket.
		// Splice returns an array of the deleted elements, just one in this case.
		const [item] = baskets[data.basketIndex].items.splice(data.itemIndex, 1);
        console.log("The drop item is : "+item);
		
    // Add the item to the drop target basket.
		baskets[basketIndex].items.push(item);
        console.log("The drop baskets item is : "+baskets[basketIndex]);
		baskets = baskets;
		console.log("The drop baskets is : "+ baskets);
        Object.entries(baskets).forEach(entry => {
